<template>
    <div>
        <div class="leftBox">
            <div class="pic"><img src="" alt="大頭貼"></div>
            <div class="myNameBox">
            ...
            <div class="linkBigBox">
                ...
                <div class="linkBox" v-for="val in nav" @click="navFun(val)">
                    {{val.ch}}<br><span>{{val.en}}</span>
                </div>
            </div>
        </div>

        <!-- <div class="clickBoxNav">
            <div class="threeLine" v-for="val in navHan"></div>
        </div> -->
    </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      nav:[
        {ch:'關於我',en:'About me',click:true},
        {ch:'作品集',en:'Profolio',click:false},
      ],
      navHan:[]
    }
  },
